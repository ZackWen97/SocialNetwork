...
//public class InputExample implements CommandLineRunner {
//    @Autowired
...
//
//        String sql = "INSERT INTO Tweet (id, title, author, price) VALUES (?, ?, ?, ?)";
//        int result = jdbcTemplate.update(sql, 1237,"Head First Java1", "Kathy Sierra1", 18.55f);
//
//        if (result > 0) {
